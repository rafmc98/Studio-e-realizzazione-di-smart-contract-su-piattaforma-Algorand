...
# define function to create atomic transactions to exchange algo for asset
def exchange() :

    # get user address
    user = get_address(user_mnemonic)
    # read TEAL program
    data = open("AlgoEcoExchange/AlgoEcoExchangeContract.teal", 'r').read()
    ...
    # calculate exchange
    eco_amount = int(input("how many ECO do you want to buy? (10 ECO = 1 Algo) "))
    algo_amount = eco_amount * 100000
